...
const reactJScodingXLoadingZipDestinationPath =
"../../zip_outputs";
...
const updatePackageJSONForTestReporter = async (inputPackageJSONPath, outputPackageJSONPath) => {
  try {
    ...
    parsedPackageJSONContent.scripts.test = "craco test --watchAll=false";
    ...
    await fsExtra.writeFile(outputPackageJSONPath, stringifiedDestination, "utf8");
    console.log(
